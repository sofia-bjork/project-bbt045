...
#SBATCH -t 4:00:00
## This is the name of the job in the scheduler ('merge_gene_counts')
...
apptainer exec $CONTAINER_LOC bash /cephyr/NOBACKUP/groups/bbt045_2025/groups/group_Bjork/Sbatch_scripts/script_merge_counts.sh
