...
###
#
# Title: Preprocessing_full_data.sh
# Date: 2024.02.23
# Author: Caesar Nelson inspired by Johan Bengtsson-Palme and Vi Varga
#
# Description: 
# This script will run fastqc on a set of input samples, specified in a loop
# 
# Usage: 
...
apptainer exec $CONTAINER_LOC bash /cephyr/NOBACKUP/groups/bbt045_2025/groups/group_Bjork/Sbatch_scripts/pre_script.sh
