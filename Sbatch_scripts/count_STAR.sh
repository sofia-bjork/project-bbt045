...
#SBATCH -t 14:00:00
## This is the name of the job in the scheduler ('counts_per_gene')
...
apptainer exec $CONTAINER_LOC bash /cephyr/NOBACKUP/groups/bbt045_2025/groups/group_Bjork/Sbatch_scripts/script_count_STAR.sh
